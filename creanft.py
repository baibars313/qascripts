...
if __name__ == '__main__':
    ...
    time.sleep(5)
    WebDriverWait(driver,30).until(EC.element_to_be_clickable((By.XPATH,'//*[@id="app-content"]/div/div[3]/div/div/div[2]/div[2]/div[2]/button[2]'))).click()
    # 
    ...
    time.sleep(10)
    hc=HumanClicker()
    nx,ny=pyautogui.locateCenterOnScreen('next.png',confidence=.7,grayscale=True)
    hc.move((nx,ny),1)
    hc.click()
    time.sleep(10)
    
    cx,cy=pyautogui.locateCenterOnScreen('connect.png',confidence=0.7,grayscale=True)
    hc.move((cx,cy),1)
    hc.click()
    time.sleep(10)
    sx,sy=pyautogui.locateCenterOnScreen('sign.png',confidence=0.7,grayscale=True)
    hc.move((sx,sy),1)
    hc.click()

    time.sleep(5)
    driver.find_element(By.XPATH,'//*[@id="root"]/div/header/div/div/div[1]/div[1]/a[1]/img').click()
    WebDriverWait(driver,10).until(EC.element_to_be_clickable((By.XPATH,'//*[@id="list-item-1"]/div[1]/div[2]/div[3]/div/a'))).click()
    WebDriverWait(driver,10).until(EC.element_to_be_clickable((By.XPATH,'//*[@id="name"]'))).send_keys('Automate creating NFT')
    WebDriverWait(driver,10).until(EC.element_to_be_clickable((By.XPATH,'//*[@id="Discription"]'))).send_keys('Automate creating NFT creatin using selenium and pyautogui opencv AI test controlled checking test to be run success fully')
    driver.find_element(By.XPATH,'//*[@id="createinputfile"]').send_keys('/home/baibars313/Documents/youtubeBot/nft1.jpg')
    time.sleep(20)
